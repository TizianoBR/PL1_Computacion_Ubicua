...
CREATE TABLE meteorology (
    ...
    uv_index INTEGER,
    PRIMARY KEY (sensor_id, street_id, timestamp),
...
INSERT INTO meteorology (sensor_id, street_id, timestamp, temperature, humidity, air_quality_index, wind_speed, wind_dir, atmospheric_pressure, uv_index) VALUES
('sensor_001', 'ST_1234', '2024-06-01 12:00:00', 25.5, 60.0, 42, 5.5, 180, 1013, 7);

INSERT INTO traffic_counter (sensor_id, street_id, timestamp, vehicle_count, pedestrian_count, bicycle_count, counter_type, technology, average_speed, occupancy_percentage, traffic_density) VALUES
('sensor_002', 'ST_5678', '2024-06-01 12:05:00', 150, 30, 20, 'inductive_loop', 'magnetic', 45.0, 75.0, 'moderate');

INSERT INTO traffic_light (sensor_id, street_id, timestamp, current_state, cycle_position, time_remaining, traffic_light_type, circulation_dir, pedestrian_waiting, pedestrian_button_pressed, malfunction_detected, cycle_count, state_changed, last_state_change) VALUES
('sensor_003', 'ST_9101', '2024-06-01 12:10:00', 'green', 3, 25, 'vehicle', 'north_south', TRUE, TRUE, FALSE, 15, TRUE, '2024-06-01 12:05:00');

INSERT INTO info_screen (sensor_id, street_id, timestamp, display_status, current_message, content_type, brightness_level, display_type, display_size, supports_color, temperature, energy_consumption, last_content_update) VALUES
